 ...
 */
public class MaximizedFunctionTest {

    // TODO mock part for which Polynomial is responsible
    @Test
    public void getBestPointReturnsPointOfHighestValue() throws Exception {
        ...
        ObjectiveFunction maxFunction = new MaximizedFunction(polynomial);
        Point bestPoint = new Point(1, 2, 3);
        ...
        // when:
        Point foundBestPoint = maxFunction.getBestPoint(points);
